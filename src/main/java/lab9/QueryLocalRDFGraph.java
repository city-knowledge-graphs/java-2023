...
public class QueryLocalRDFGraph {
	...
	public static void main(String[] args) {
		...
		if (test.equals("playground")) {
			...
			//query_file = "files/lab9/solution/query7.1_playground.txt";
			//query_file = "files/lab9/solution/query7.2_playground.txt";
			//query_file = "files/lab9/solution/query7.3_playground.txt";
		}
			...
			//query_file = "files/lab9/solution/query7.4_world-cities.txt"; 
		}
		else {
			//Nobel prize		
			...
			//query_file = "files/lab9/solution/query7.6_nobel-prize.txt";
		}		
